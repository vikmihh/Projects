<template>
    ...
    <div class="row">
        <div class="col-md-12">
            <div>
                <div v-if="errorMessage != null && firstName.length < 1 || firstName.length >= 129"
                ...
                <div class="form-group">
                    ...
                    <input v-model="firstName" min="1" max="128" class="form-control" type="text" />
                </div>
                <div v-if="errorMessage != null && lastName.length < 1 || lastName.length >= 129"
                    class="text-danger validation-summary-errors" data-valmsg-summary="true">
                    <ul>
                ...
                <div class="form-group">
                    ...
                    <input v-model="lastName" min="1" max="128" class="form-control" type="text" />
                </div>
                <div v-if="errorMessage != null && cardNumber.toString().length != 16"
                    class="text-danger validation-summary-errors" data-valmsg-summary="true">
                    <ul>
                ...
                <div class="form-group">
                    ...
                    <input v-model="cardNumber" class="form-control" type="number" />

                </div>
                <div v-if="errorMessage != null && securityCode.toString().length != 3"
                    class="text-danger validation-summary-errors" data-valmsg-summary="true">
                    <ul>
                ...
                <div class="form-group">
                    ...
                    <input v-model="securityCode" class="form-control" type="number" />

                </div>
                <div v-if="errorMessage != null && expiryMonth.toString().length != 2"
                    class="text-danger validation-summary-errors" data-valmsg-summary="true">
                    <ul>
                ...
                <div v-if="errorMessage != null && expiryYear.toString().length != 4"
                    class="text-danger validation-summary-errors" data-valmsg-summary="true">
                    <ul>
...
export default class CardCreate extends Vue {
    ...
    async submitClicked(): Promise<void> {
        ...
        if (this.isFormCorrectlyFilled()) {
            ...
            var res = await this.cardService.add(
                {
